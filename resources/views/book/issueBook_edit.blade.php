...
@section('content')
    ...
    <div id="admin-content">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h2 class="admin-heading">Buku Kembali</h2>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="yourform">
                        ...
                        @if ($book->issue_status == 'N')
                            <form action="{{ route('book_issue.update', $book->id) }}" method="post" autocomplete="off">
                                @csrf
                                <input type='submit' class='btn btn-danger' name='save' value='Return Book' onclick= "return confirm('Yakin ingin mengganti data ini?')">
                            </form>
                        @endif
                    </div>
                </div>
