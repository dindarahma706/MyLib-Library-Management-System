            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="menu">
                        ...
                        <li><a href="{{ route('authors') }}">About Us</a></li>
                        <li><a href="{{ route('publishers') }}">Login Admin</a></li>
                        <li><a href="{{ route('categories') }}">Login User</a></li>
                        <li><a href="{{ route('books') }}">Daftar</a></li>
                    </ul>
                </div>
            </div>
        </div>
